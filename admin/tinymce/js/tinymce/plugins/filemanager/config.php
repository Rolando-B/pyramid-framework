...
$upload_dir = "/".ROOTDIR."/../../../../../images"; // path from base_url to upload base dir
...
$ext_file = array('doc','tiff', 'docx', 'pdf', 'xls', 'xlsx', 'txt', 'csv','html','psd','sql','log','fla','xml','ade','adp','ppt','pptx'); //Files
